...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:an,depthTest:!1,depthWrite:!1})}function ua(){return new bn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Qr(),fragmentShader:`
		...
		`,blending:an,depthTest:!1,depthWrite:!1})}function ha(){return new bn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Qr(),fragmentShader:`
...
`].filter(li).join(`
`)),o=Xr(o),o=Ma(o,t),o=Sa(o,t),a=Xr(a),a=Ma(a,t),a=Sa(a,t),o=Ea(o),a=Ea(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(w=`#version 300 es
