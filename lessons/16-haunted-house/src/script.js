...
const door = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({ 
        ...
        oaMap: doorAmbientOcclusionTexture,
...
const tick = () =>
{
    ...
    // Update door light
    doorLight.intensity = Math.sin(elapsedTime * 5) * 2 + 3
    doorLight.position.x = Math.sin(elapsedTime * 5) * 0.5

    // Update graves
    graves.children.forEach(grave => {
        const angle = elapsedTime * 4
        grave.position.y = Math.sin(angle) * 0.1
    })
