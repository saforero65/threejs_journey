...
// gui.add(material.normalScale, 'x').min(-1).max(1).step(0.001)
// material.transparent = true
// material.alphaMap = doorAlphaTexture
// material.side = THREE.DoubleSide
...
const torus = new THREE.Mesh( new THREE.TorusGeometry(0.3, 0.15, 64, 64), material)
